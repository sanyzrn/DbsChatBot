...
class SSC_Chatbot_Frontend {
        ...
        public function maybe_render_floating() {
                ...
                // خروجی render() یک رشتهٔ کاملاً ثابت و داخلی است (بدون هیچ ورودی کاربر)،
                // پس از wp_kses_post عبور داده نمی‌شود؛ kses در برخی پیکربندی‌ها ویژگی‌های
                // مانند dir/aria را حذف می‌کرد و جهت چت‌بات خراب می‌شد.
                echo $this->render(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- رشتهٔ ثابت داخلی، بدون ورودی کاربر.
        }
